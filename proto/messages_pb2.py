...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_REPLY']._serialized_end=52
  _globals['_GATEWAY']._serialized_start=55
  _globals['_GATEWAY']._serialized_end=393
